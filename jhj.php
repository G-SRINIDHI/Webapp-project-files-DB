    ...
    $pattern=array();
		...
		while(!feof($file))
		{
	        ...
	        if($pat[0]== $searchfor)
			{
                ...
                //echo("$pat[1]\n");
            $found=1;
            $file=fopen("hts.txt","r") or die("unable to open file");
            fseek($file,$pat[1]);
            $line=fgets($file);
...
<div class="header">
<center><a href="wlcome page.html"><button type="submit" value="back"><b>logout</b></button></center>
</head>
